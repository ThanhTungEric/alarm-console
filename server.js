...
app.post('/api/sensor', (req, res) => {
    const { sensor, sensor_state, acknowledgment_state, alarm_class, priority, message } = req.body;
    const sql = 'INSERT INTO alarm (sensor, sensor_state, acknowledgment_state, alarm_class, priority, message) VALUES (?, ?, ?, ?, ?, ?)';

    db.query(sql, [sensor, sensor_state, acknowledgment_state, alarm_class, priority, message], (err, result) => {
